...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      <div className="w-screen h-screen md:w-[60vw] px-14 pt-8 pb-12">
        {/* <h2 className='text-xl font-semibold text-black' >Expense Tracker</h2> */}
        <h2 className=" text-2xl font-bold text-black dark:text-white tracking-tight transition-all duration-500 ease-in-out hover:scale-105 hover:tracking-wider">
          Expense Tracker
        </h2>
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auto-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-[20px] border-slate-700 absolute top-[30%] -right-10 "></div>
        ...
        <img
          src={CARD_2}
          alt="this is an banner image"
          className="w-64 lg:w-[90%] absolute bottom-10 shadow shadow-blue-400/15 rounded-2xl "
        />
      </div>
    </div>
  );
...
const StatesInfoCard = ({ icon, label, value, color }) => {
  return (
    <div className="z-20 flex  gap-6 bg-white p-4 rounded-xl shadow-md shadow-slate-200">
      <div
